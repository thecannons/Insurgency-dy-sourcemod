...
public FindValidAntenna()
{
	...
	while ((prop = FindEntityByClassname(prop, "prop_dynamic_override")) != INVALID_ENT_REFERENCE)
	{
		...
		if (StrEqual(propModelName, "models/Sernix/IED Jammer/eid_jammer.mdl"))
		{
			return prop;
		}
...
public GetPropType(entity)
{
	...
	else if (StrEqual(propModelName, "models/Sernix/IED Jammer/eid_jammer.mdl") || StrEqual(propModelName, "models/static_afghan/prop_panj_stairs.mdl"))
	{
		propType = 3;
	}
	else if (StrEqual(propModelName, "models/Sernix/Ammo Cache/Small/ammo_cache_small.mdl"))
	{
		propType = 4;
	}
	return propType;
